                    ...
                    <form onSubmit={handleSubmit} method="POST">
                      ...
                      <div className="relative mb-4" data-te-input-wrapper-init>
                        ...
                        <label
                          ...
                          className={`${email.length != 0 ? '-translate-y-[0.9rem] scale-[0.8] text-orange-600 peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-black-200 dark:text-black-200' : ''} font-semibold pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-black-500 transition-all duration-200 ease-out`}
                        >
                          E-mail
                        </label>
                      </div>
