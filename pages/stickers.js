...
function Stickers({products}) {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4 justify-center">
      ...
      {Object.keys(products).length === 0 && <p className='font-semibold mx-5'>Sorry ! Currently Stickers are out of stock right now But Stay Tuned As we will soon bring them back in Stock</p>}
