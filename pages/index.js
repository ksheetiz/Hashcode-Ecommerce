  ...
  return (
    <>
      ...
      <section className="text-gray-600 body-font">
        <Image src='/home.jpg' width='1900' height='1000'/>
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-6 rounded-lg">
                <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-orange-100 text-orange-500 mb-4">
                  <svg fill="none" stroke="currentColor" strokeLinecap="round" sstrokelinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
